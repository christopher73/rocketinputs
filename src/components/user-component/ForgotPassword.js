    ...
    <Grid style={{display:"flex", justifyContent:"center", alignItems:"center", minHeight:"100%" }}>
      <Paper elevation={10} style={{padding:30, width:"33%"}}>
        <Grid align="center">
          ...
          <Typography color="primary" component="h6" variant="h6" > FORGOT PASSWORD </Typography>
          <hr />
        </Grid>
        <TextField 
        ...
        <TextField 
          ...
          onChange={e=>handleChange(e)} 
        />
        <Button  type="submit" color="primary" variant="contained" size="large" className={classes.btnLogin} fullWidth onClick={handleSubmit}>CHANGE</Button>
        <Typography> Do you have an account? <Link href="/">Log In</Link></Typography>
        <Typography> Create a new account? <Link href="/register" >Sign Up</Link></Typography>
      </Paper>
    </Grid>
  )
}
